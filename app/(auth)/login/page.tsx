    ...
    <main className="min-h-screen bg-kira-obsidian flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="font-display text-2xl font-bold text-kira-cream tracking-wide">Welcome Back</h1>
          <p className="text-kira-cream-dim text-sm mt-2 font-body">Sign in to continue with KIRA</p>
        </div>
        ...
        <p className="text-center text-kira-cream-dim/60 text-sm mt-6 font-body">
          New to KIRA?{' '}
          <Link href="/register" className="text-kira-gold hover:text-kira-gold-light transition-colors">
            Create Account
          </Link>
        </p>
      </div>
